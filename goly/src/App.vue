...
<header class="relative z-50 w-full h-24">
        <div
            class="container flex items-center justify-center h-full  px-8 mx-auto sm:justify-between xl:px-0">

            <a href="/" class="relative flex items-center inline-block h-5 h-full font-black leading-none">
                <img src="./assets/logo.png">
            </a>

            <svg class=" hidden w-screen max-w-2xl -mt-72 -ml-12 lg:block"
